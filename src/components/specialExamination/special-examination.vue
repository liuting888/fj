  ...
  <div class="fj-content_view work-mis workLog specialExamination">
    ...
    <div class="fj-block content">
      ...
      <div class="fj-block-body">
        <div class="fj-search-inline">
          <el-row>
            <el-form inline label-width="85px" label-position="left">
              <el-col :lg="6" :xl="5">
                <el-form-item label="考试类型：" v-if="activeName==0">
                  <el-select
                    @change="changeDeptId"
                    clearable
                    filterable
              ...
              <el-col :lg="6" :xl="5" v-if="activeName==1">
              ...
              <el-col :lg="6" :xl="5" v-if="activeName==2">
              ...
              <el-col :lg="8" :xl="7" class="time-item">
                <el-form-item label="起始时间：" class="datepicker">
                  <el-date-picker
                    ...
                    size="small"
                  ></el-date-picker>
                  <el-button type="primary" class="tj-btn" @click="searchAttendLeave" v-if="activeName==0">创建题库
                    <router-link to=""></router-link>
                  </el-button>
                  <el-button type="primary" class="tj-btn" @click="searchAttendLeave" v-if="activeName==1">添加试卷</el-button>
                  <el-button type="primary" class="tj-btn" @click="searchAttendLeave" v-if="activeName==2">导出</el-button>
                </el-form-item>
              </el-col>
            </el-form>
          </el-row>
        ...
        <!-- 考试题库 -->
        <el-table v-if="activeName==0" :data="tableDataList" style="width: 100%">
        ...
        <!-- 试卷管理 -->
        <el-table v-if="activeName==1" :data="tableDataList" style="width: 100%">
