<template>
  <div class="fj-content_view fj-leave">
      ...
      <div class="fj-block-body">
        <ul class="filterOpe-area fj-clear">
          <li class="area-line fj-clear">
            ...
            <fj-dept @change-fenjv="changeSupDeptId" @change-pcs="changeDeptId"></fj-dept>
            <div class="item fj-fl">
              <span class="title fj-fl">申请时间：</span>
              <el-date-picker
          ...
          <li class="area-line fj-clear">
            <div class="item fj-fl">
              <span class="title fj-fl">批准结果：</span>
              <el-select
                @change="changeStatus"
                clearable
