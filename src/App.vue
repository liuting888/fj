...
.fj-login-area {
  /* top:74px;bottom:74px;left:126px;right:126px; */
  top: 50%;
  left: 50%;
  margin-left: -558px;
  margin-top: -310px;
...
.fj-login-area > .fj-login-inner > .login-info > .title:after {
  content: "";
  position: absolute;
  left: 0;
  bottom: 0;
...
.fj-login-area > .fj-login-inner > .login-info > .insert-line:last-of-type {
  margin-bottom: 30px;
}
