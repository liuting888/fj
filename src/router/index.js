...
export default new Router({
    ...
    {
        //考勤管理 -> 考勤配置
        path: '/fjAttend-configure',
        name: 'fjAttend-configure',
        component: resolve => require(['@/components/fjAttend-configure'], resolve)
    },
    {
        //考勤管理 -> 排班管理
        path: '/fjAttend-work-manage',
        name: 'fjAttend-work-manage',
        component: resolve => require(['@/components/fjAttend-work-manage'], resolve),
        /* redirect:'/fjAttend-work-manage/work-configure',
        children:[
            {
                path:'work-configure', 
                component: resolve => require(['@/components/fjAttend-work-configure'], resolve),
            },
            {
                path: 'intel-schedule',
                component: resolve => require(['@/components/fjAttend-intel-schedule'], resolve),
            }
        ] */
    },
    {
